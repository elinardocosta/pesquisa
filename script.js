                ...
                Promise.all(textPromises).then(function (pages) {
                    ...
                    for (let i = 0; i < pages.length; i++) {
                        ...
                        for (const item of codesListWithNames) {
                            ...
                            const codeWithDots = code.split('').join('.?'); // Transforma '8285187' em '8.2.8.5.1.8.7'
                            const regex = new RegExp(codeWithDots, 'g');
                    ...
                    if (results.length > 0) {
                        ...
                        resultsDiv.innerHTML = "<br><span style='font-size: 20px;'>Nenhum resultado encontrado.</span><br>";
                    }
