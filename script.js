                        ...
                        for (const item of codesListWithNames) {
                            ...
                            if (linesInfo.length > 0) {
                                ...
                                linesInfo.forEach(info => {
                                    resultsDiv.innerHTML += `<a href="https://diariooficial.prefeitura.sp.gov.br/md_epubli_controlador.php?acao=inicio" onclick="goToPage(${info.page})">Página ${info.page}</a>, `;
                                });
