/* Adicione os scripts para abrir e fechar o popup -->
 // Lista de RF a serem pesquisados
        ...
        { code: "8791210", name: "ANA PAULA RODRIGUES HONORIO" }, { code: "879.121.0", name: "ANA PAULA RODRIGUES HONORIO" },
        { code: "8063494", name: "ANA PAULA VIANA COSTA" }, { code: "806.349.4", name: "ANA PAULA VIANA COSTA" },
        { code: "8821186", name: "ANGELA MARIA DE OLIVEIRA" }, { code: "882.118.6", name: "ANGELA MARIA DE OLIVEIRA" },
        { code: "8978620", name: "ANGELA SELMA DA SILVA E MELO" }, { code: "897.862.0", name: "ANGELA SELMA DA SILVA E MELO" },
        { code: "8109788", name: "ANTONIO CARLOS SACRAMENTODA CONCEICAO" }, { code: "810.978.8", name: "ANTONIO CARLOS SACRAMENTODA CONCEICAO" },
        { code: "8259640", name: "APARECIDA VIEIRA DA SILVA" }, { code: "825.964.0", name: "APARECIDA VIEIRA DA SILVA" },
        { code: "9153055", name: "BEATRIZ BRANDAO" }, { code: "915.305.5", name: "BEATRIZ BRANDAO" },
        { code: "8171831", name: "BEATRIZ CAROLINE BISPO DIAS" }, { code: "817.183.1", name: "BEATRIZ CAROLINE BISPO DIAS" },
        { code: "8421790", name: "BEATRIZ NOGUEIRA DE SOUSA" }, { code: "842.179.0", name: "BEATRIZ NOGUEIRA DE SOUSA" },
        { code: "7449607", name: "BENEDITA LIMA KECEK" }, { code: "744.960.7", name: "BENEDITA LIMA KECEK" },
        { code: "7916744", name: "BRUNO ALEXANDRE DEANINI" }, { code: "791.674.4", name: "BRUNO ALEXANDRE DEANINI" },
        { code: "9145761", name: "BRUNO CAUE DE SOUZA" }, { code: "914.576.1", name: "BRUNO CAUE DE SOUZA" },
        { code: "7822529", name: "CARLA FERNANDA BARRETO" }, { code: "782.252.9", name: "CARLA FERNANDA BARRETO" },
        { code: "8965021", name: "CARLOS ROBERTO LANDIM SOUZA SANTOS" }, { code: "896.502.1", name: "CARLOS ROBERTO LANDIM SOUZA SANTOS" },
        ...
        { code: "8207704", name: "DANIELA TAVARES MAXIMO DA SILVA" }, { code: "820.770.4", name: "DANIELA TAVARES MAXIMO DA SILVA" },
        ...
        { code: "9233512", name: "ELIONAI CRUZ CONCEICAO COELHO" }, { code: "923.351.2", name: "ELIONAI CRUZ CONCEICAO COELHO" },
        { code: "7954123", name: "ELOIZA DA SILVA SOUZA" }, { code: "795.412.3", name: "ELOIZA DA SILVA SOUZA" },
        { code: "8230901", name: "FABIANA ANDRADE DE LACERDA SILVA" }, { code: "823.090.1", name: "FABIANA ANDRADE DE LACERDA SILVA" },
        ...
        { code: "8257833", name: "FABIO FERREIRA RAMOS" }, { code: "825.783.3", name: "FABIO FERREIRA RAMOS" },
        { code: "9241825", name: "FERNANDA DE CASSIA GALVAO BASTOS" }, { code: "924.182.5", name: "FERNANDA DE CASSIA GALVAO BASTOS" },
        ...
        { code: "9229469", name: "IVANIA ALVES GOMES DA SILVA" }, { code: "922.946.9", name: "IVANIA ALVES GOMES DA SILVA" },
        ...
        { code: "9212451", name: "JULIA AZEREDO DA SILVA" }, { code: "921.245.1", name: "JULIA AZEREDO DA SILVA" },
        { code: "8183031", name: "JOSE AUGUSTO LOPES DE ALENCAR" }, { code: "818.303.1", name: "JOSE AUGUSTO LOPES DE ALENCAR" },
        { code: "9287507", name: "KAWE VINICIUS GONCALVES DE SOUZA" }, { code: "928.750.7", name: "KAWE VINICIUS GONCALVES DE SOUZA" },
        ...
        { code: "9156011", name: "LILIANE REGINA LIMA SILVA" }, { code: "915.601.1", name: "LILIANE REGINA LIMA SILVA" },
        { code: "6789587", name: "LUIZ CARLOS CRISTAN" }, { code: "678.958.7", name: "LUIZ CARLOS CRISTAN" },
        { code: "8844909", name: "MARCO ANTONIO DE ALMEIDA" }, { code: "884.490.9", name: "MARCO ANTONIO DE ALMEIDA" },
        ...
        { code: "7871848", name: "MARISA GOI DE OLIVEIRA" }, { code: "787.184.8", name: "MARISA GOI DE OLIVEIRA" },
        { code: "9243232", name: "MICHELLE CARLA VICENTE MARQUES" }, { code: "924.323.2", name: "MICHELLE CARLA VICENTE MARQUES" },
        { code: "7926898", name: "MILTON UCHOA SA JUNIOR" }, { code: "792.689.8", name: "MILTON UCHOA SA JUNIOR" },
        { code: "8839131", name: "OLINDA ROBERTO LEANDRO" }, { code: "883.913.1", name: "OLINDA ROBERTO LEANDRO" },
        ...
        { code: "7877447", name: "RODRIGO ALVES QUINTIERE" }, { code: "787.744.7", name: "RODRIGO ALVES QUINTIERE" },
        ...
        { code: "7866534", name: "ROSEMEIRE JUSTINO DOS SANTOS DE OLIVEIRA" }, { code: "786.653.4", name: "ROSEMEIRE JUSTINO DOS SANTOS DE OLIVEIRA" },
        { code: "9243771", name: "ROSILEIDE BELCHIOR DE ARARUNA" }, { code: "924.377.1", name: "ROSILEIDE BELCHIOR DE ARARUNA" },
        { code: "8346178", name: "SAMUEL FERREIRA DE CAMPOS" }, { code: "834.617.8", name: "SAMUEL FERREIRA DE CAMPOS" },
        { code: "8163111", name: "SANDRO RAMOS DOS SANTOS" }, { code: "816.311.1", name: "SANDRO RAMOS DOS SANTOS" },
        { code: "8482616", name: "SUE ELLEN CRISTINA LUZ DE MELO CADETE" }, { code: "848.261.6", name: "SUE ELLEN CRISTINA LUZ DE MELO CADETE" },
        ...
        { code: "7546823", name: "VERA LUCIA AYKO TAKARA" }, { code: "754.682.3", name: "VERA LUCIA AYKO TAKARA" },
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Carregue dados existentes do armazenamento local
    const savedData = JSON.parse(localStorage.getItem("codeAndNameData")) || [];

    // Exiba dados existentes
    ...
    codeForm.addEventListener("submit", function (e) {
        ...
        // Obtenha o código e o nome do formulário
        const code = codeInput.value.trim();
        const name = nameInput.value.trim();

        if (code && name) {
            // Adicione o código e o nome à lista
    ...
    // Função para criar um item de lista e adicioná-lo à lista
...
// Função para ocultar a barra de aguarde
...
function searchCodes() {
    ...
    const codesListWithNames = [
        ...
        { code: "7919905", name: "VIVIANE CARVALHO DE OLIVEIRA" }, { code: "791.990.5", name: "VIVIANE CARVALHO DE OLIVEIRA" }
        // Adicione mais códigos e nomes se necessário
        // Códigos e nomes omitidos para brevidade
    ];

    if (selectedFile) {
        // Verifica se o arquivo selecionado é um PDF
        if (selectedFile.type !== 'application/pdf') {
            resultsDiv.innerHTML = "<br><span style='font-size: 24px;'>Atenção: Selecione um arquivo .PDF </span>" + "<br>";
            ocultarBarraDeAguarde();
            return; // Sai da função se não for um PDF
        }
        ...
        fileReader.onload = function (e) {
            ...
            pdfjsLib.getDocument(pdfData).promise.then(function (pdfDoc) {
                ...
                Promise.all(textPromises).then(function (pages) {
                    const foundCodes = new Map(); // Usando um Map para armazenar códigos encontrados e suas páginas correspondentes
                    const results = [];
                    ...
                    for (let i = 0; i < pages.length; i++) {
                        ...
                        for (const item of codesListWithNames) {
                            ...
                            const regex = new RegExp(`\\b${code.replace('.', '\\.')}\\b`, 'g'); // Expressão regular para procurar o código exato
                            if (regex.test(pageText)) {
                                // Adiciona o código e a página ao Map de códigos encontrados
                                if (!foundCodes.has(code)) {
                                    foundCodes.set(code, []);
                                }
                                foundCodes.get(code).push(i + 1); // Número da página é i + 1
                            }
                        }
                    }

                    // Monta os resultados
                    for (const [code, pages] of foundCodes.entries()) {
                        const matchingItem = codesListWithNames.find(item => item.code === code);
                        if (matchingItem) {
                            results.push({ code: matchingItem.code, name: matchingItem.name, pages: pages.join(', ') });
                        }
                    }
                    ...
                    if (results.length > 0) {
                        ...
                        resultsDiv.innerHTML = "<br><span style='font-size: 24px;'>Nenhum resultado encontrado.</span><br>";
                    }
        ...
        resultsDiv.innerHTML = "<br><span style='font-size: 24px;'>Atenção: Selecione o arquivo PDF da Edição.</span>" + "<br>";
        ocultarBarraDeAguarde();
    }
}
